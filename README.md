...
### v1.12.12
- **Màn Nguồn**: ô đổi tên thành **"Header là dòng"** — lấy **đúng dòng Excel bạn nhập** làm header (đọc thẳng dòng đó, không tự bỏ dòng trống), khớp tuyệt đối kể cả khi có dòng trống ở trên. Dòng gợi ý hiện **đúng nội dung dòng đó** (`Giá trị dòng x: …`), không còn lệch sang dòng dữ liệu x+1.
